...
const Complete_Package = () => {
    ...
    return (
        <SectionWrap sectionName="Complete Pakcage"
            ...
            <>
                <div className="w-full lg:container mx-auto px-4">
                    <div className="flex flex-row flex-wrap justify-between mt-8">
                        {
                            PACKAGE_DATA.map((data) => <div key={data.slug}
                    ...
                    <div className="flex flex-row flex-wrap justify-start my-8">
                        {
                            TECH_STACK.map((data, index) =>
                                <div key={`${index}-${data}`} className="relative w-[16%] max-md:w-[24%] 
...
export default Complete_Package;